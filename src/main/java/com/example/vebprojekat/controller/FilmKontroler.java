...
public class FilmKontroler {
    ...
    public String filmovi(Model model){
        ...
        /*ist<FilmDTO> filmoviDTO = new ArrayList<>();
    ...
    @PostMapping("/filmovi_pretraga")
    public String filmovi_pretraga(@ModelAttribute Pretraga pretraga_string, Model model){
    ...
    @PostMapping("/sortiraj")
    public String sortiraj(@ModelAttribute(name = "sort") Sort sort, Model model){
        model.addAttribute("pretraga_string", new Pretraga());
        model.addAttribute("sort", new Sort());
