...
public class FilmURasporedu extends Film{
    ...
    public FilmURasporedu(Long id, String naziv, String opis, String zanr, Integer trajanje, Double prosecna_ocena, Set<TerminskaLista> terminske_liste, Integer cena, Integer br_rezervisanih, String vreme_projekcije) {
