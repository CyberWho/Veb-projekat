...
INSERT INTO Korisnik(type, id, lozinka, ime, prezime, kontakt_telefon, email, datum_rodjenja, uloga, aktivan, korisnickoime, approved) VALUES ('Menadzer', 6, 'pass', 'Nikola', 'Nikolic', '564212', 'nikola@bioskopi.rs', '2020-06-19', 1, true, 'nikola_mngr', true);
...
INSERT INTO Projekcija(film_id, bioskop_id, cena, datumvreme, sala_id) VALUES (3, 1, 350, '2020-7-26 15:00', 1);
INSERT INTO Projekcija(film_id, bioskop_id, cena, datumvreme, sala_id) VALUES (4, 1, 450, '2020-7-26 17:00', 2);
INSERT INTO Projekcija(film_id, bioskop_id, cena, datumvreme, sala_id) VALUES (5, 2, 250, '2020-7-26 15:00', 2);
INSERT INTO Projekcija(film_id, bioskop_id, cena, datumvreme, sala_id) VALUES (6, 2, 250, '2020-7-25 16:00', 2);
